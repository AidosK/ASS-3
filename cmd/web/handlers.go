...
func (app *application) loginUser(w http.ResponseWriter, r *http.Request) {
	...
	id, err := app.users.Authenticate(form.Get("email"), form.Get("password"), form.Get("role"))
	if err != nil {
...
func (app *application) createSnippet(w http.ResponseWriter, r *http.Request) {
	...
	role := app.session.Get(r, "role")
	if role != "teacher" {
		http.Error(w, "Unauthorized to create news", http.StatusForbidden)
	}
